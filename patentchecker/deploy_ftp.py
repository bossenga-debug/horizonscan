...
# patentchecker.html wordt index.html op
# https://medicatieadvies.nl/patentchecker/. Dat vraagt een FTP-account met
# public_html als hoofdmap (hetzelfde als voor horizonscan en addon); het
# oorspronkelijke account van het preferentiebeleid is vastgezet op zijn eigen
